 ...
 */
export type PaymentProvider = 'stripe' | 'coinbase' | 'paypal' | 'apple' | 'sezzle' | 'splitit' | 'platform_balance' | 'multi_psp' | 'adyen' | 'claritypay' | 'checkout_dot_com' | 'airwallex' | 'coinflow';
/**
